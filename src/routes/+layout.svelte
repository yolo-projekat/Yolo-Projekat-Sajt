<script lang="ts">
    ...
    function scrollTo(id: string): void {
        ...
        if (el) {
            ...
            isMenuOpen = false; // Zatvara meni na mobilnom nakon klika
        }
    }
</script>
...
<nav class="navbar" class:scrolled>
    <div class="nav-content">
        ...
        <div class="nav-links" class:active={isMenuOpen}>
            ...
            <a href="https://github.com/yolo-projekat/Yolo-Projekat-Sajt" target="_blank" class="cta-button">
                <span>GitHub</span>
